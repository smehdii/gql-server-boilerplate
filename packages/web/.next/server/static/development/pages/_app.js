...
var apolloMap = {}; // Polyfill fetch() on the server (used by apollo-client)
...
function create(linkOptions, initialState, _ref) {
  var getToken = _ref.getToken;
  var cacheConfig = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  var httpLink = Object(apollo_link_http__WEBPACK_IMPORTED_MODULE_1__["createHttpLink"])(linkOptions);
  ...
  return new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["ApolloClient"]({
    ...
    cache: new apollo_boost__WEBPACK_IMPORTED_MODULE_0__["InMemoryCache"](cacheConfig).restore(initialState || {})
  });
}

function initApollo(linkOptions, initialState, options) {
  var cacheConfig = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  ...
  if (!apolloMap[linkOptions.uri]) {
    apolloMap[linkOptions.uri] = create(linkOptions, initialState, options, cacheConfig);
  }

  return apolloMap[linkOptions.uri];
}
...
/* harmony import */ var _init_apollo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./init-apollo */ "./lib/init-apollo.ts");
/* harmony import */ var _isBrowser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./isBrowser */ "./lib/isBrowser.ts");

var _jsxFileName = "/home/viirtual/Projects/gql-server-boilerplate/packages/web/lib/with-apollo-client.tsx";
...
/* harmony default export */ __webpack_exports__["default"] = (function (App) {
  ...
  function (_React$Component) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  apollo = Object(_init_apollo__WEBPACK_IMPORTED_MODULE_6__["default"])(SERVER_LINK_OPTIONS, {}, {
                  ...
                  ctx.ctx.apolloClient = apollo; // ctx.ctx.githubApolloClient = githubApolloClient;
                ...
                case 10:
                  ...
                  return Object(react_apollo__WEBPACK_IMPORTED_MODULE_4__["getDataFromTree"])(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(App, _extends({}, appProps, {
                    Component: Component,
                    router: router,
                    apolloClient: apollo // githubApolloClient={githubApolloClient}
                    ,
                    __source: {
                ...
                case 20:
                  ...
                  apolloState = apollo.cache.extract(); // const githubApolloState = githubApolloClient.cache.extract();

                  return _context.abrupt("return", _objectSpread({}, appProps, {
                    // me,
                    apolloState: apolloState // githubApolloState
    ...
    function WithData(props) {
      ...
      _this.apolloClient = Object(_init_apollo__WEBPACK_IMPORTED_MODULE_6__["default"])(SERVER_LINK_OPTIONS, props.apolloState, {
        getToken: function getToken() {
